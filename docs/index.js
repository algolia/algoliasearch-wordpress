...
var communityHeaderData = JSON.parse(fs.readFileSync('./component_data/community_header.json').toString());

var sassPaths = [
    'node_modules/foundation-sites/scss',
    'node_modules/algolia-components/dist/_community_header.css'
];
...
var siteBuild = Metalsmith(__dirname)
    ...
    .metadata({
        ...
        header: algoliaComponents.community_header.html.render(communityHeaderData)
    })
    ...
    .use(asset({
        src: './node_modules/algolia-components/dist/_community_header.js',
        dest: './js/community_header.js'
    }))
